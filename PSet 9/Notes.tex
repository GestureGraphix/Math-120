...
\sol{
    ...
    \[ \vec{F} = -\frac{\sqrt{2} \sin \theta}{2} \, \hat{i} + \frac{\sqrt{2} \cos \theta}{2} \, \hat{j} = \left\langle -\frac{\sin \theta}{\sqrt{2}}, \frac{\cos \theta}{\sqrt{2}} \right\rangle. \]
    \[ \vec{F} \cdot d\vec{r} = \left\langle -\frac{\sin \theta}{\sqrt{2}}, \frac{\cos \theta}{\sqrt{2}} \right\rangle \cdot \left\langle -\sqrt{2} \sin \theta, \sqrt{2} \cos \theta \right\rangle. \]
    \[ \vec{F} \cdot d\vec{r} = d \theta \, \left( -\frac{\sin \theta}{\sqrt{2}} \right)( -\sqrt{2} \sin \theta ) + d \theta \left( \frac{\cos \theta}{\sqrt{2}} \right)( \sqrt{2} \cos \theta ). \] 
    \[ = \sin^2 \theta \, d \theta + \cos^2 \theta \, d \theta = 1 \Rightarrow d \theta . \]
