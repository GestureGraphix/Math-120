...
\sol{
	...
	\[  \frac{(2y) \left(1 + (xy)^{2}\right) - \left(y^{2}\right)\left(2x^{2}y\right)}{\left(1 + \left( xy\right)^{2} \right)} = \frac{2y}{\left(1 + (xy)^{2}\right)}\]   
	\[ f_{y} = \frac{\partial}{\partial y}  y \arctan(xy) = \arctan(xy) + \frac{xy}{1 + (xy)^{2}} \]
	\[ \frac{\partial}{\partial x} \arctan(xy) + \frac{xy}{1 + (xy)^{2}} = \frac{y}{(1+(xy)^{2})}  + \frac{y\left(1 + (xy)^{2}\right) - \left(2y^{2}x\right)(xy)}{\left( 1+ \left( xy\right)^{2} \right)^{2}} = \frac{2y}{\left(1 + (xy)^{2}\right)} \]  
}
\newpage 
