...
\addcontentsline{toc}{subsection}{Distacnes and Spheres}
...
\chapter*{13}
\addcontentsline{toc}{chapter}{Vector Functions}

\section*{13.1 Vector Functions and Space Curves}
\addcontentsline{toc}{section}{Vector Functions and Space Curves}

\section*{13.2 Derivatives and Integrals of Line Functions}
\addcontentsline{toc}{section}{Derivatives and Integrals of Line Functions}


\section*{13.3 Arc Length and Curvature}
\addcontentsline{toc}{section}{Arc Length and Curvature}

\section*{13.4 Motion in Space: Veolcity and Acceleration}
\addcontentsline{toc}{section}{Motion in Space: Velocity and Acceleration}

\chapter*{14 Partial Derivatives}
\addcontentsline{toc}{chapter}{Partial Derivatives}
