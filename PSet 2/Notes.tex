...
\sol{
	...
	c)
	\[ \vec{v_{1}} = \langle 2, -1 \rangle \]
	\[ y_{2} = 5x - 2 \] 
	\[ \vec{v_{2}} = \langle 1, 5 \rangle \]
	\[ \cos(\theta) = \frac{v_{1} \cdot v_{2}}{|v_{1}| |v_{2}|}\] 
	\[ \cos(\theta) = \frac{2 - 5}{\sqrt{5}\sqrt{26}} = - \frac{3}{\sqrt{130}} \]
	\[ \theta = 180 - \arccos \left( - \frac{3}{\sqrt{130}}\right) \approx 75\]  	
}
...
\sol{
	...
	\[ \frac{2 - \left(4 + \sqrt{13}\right)}{{2}{\sqrt{5 + (4 + \sqrt{13})^{2}}}} = -0.5\] 
	\[ \frac{2 - \left(4 - \sqrt{13}\right)}{{2}{\sqrt{5 + (4 - \sqrt{13})^{2}}}} = 0.5 \] 
	\[ x = 4 - \sqrt{13} \]      
}
	...
	\begin{center}
		\begin{tikzpicture}
			\begin{axis}[
				...
				ylabel = $y$,
				zlabel = {$z$},
				view={60}{30}, % Adjust the angle for 3D view
				zmax=2, zmin=-2,
				xmax=4, xmin=-4,
				ymax=4, ymin=-4
			]
			
			% Draw several sample vectors that satisfy 3b_2 - b_1 > 0
			\addplot3[blue,->,thick] coordinates {(0,0,0) (-6,2,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (-5,2,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (-4,2,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (-3,2,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (-2,2,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (-1,2,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (0,1,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (1,2,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (2,3,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (3,4,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (4,5,0)};
			\addplot3[blue,->,thick] coordinates {(0,0,0) (5,6,0)};
			\end{axis}
		\end{tikzpicture}
	\end{center}
}
...
\sol{
	...
	b).   
	\[ \ray{NM} = \langle 3 -3, 8 - 7, 6 - 3 \rangle = \langle 0, 1, 3 \rangle \] 
	\[ \ray{KM} = \langle 3 - 1, 8 - 3, 6 - 6 \rangle = \langle 2, 5, 0 \rangle\] 
	\[ |\ray{Kl}| = \sqrt{0^{2} + 1^{2} + 3^{2}} = \sqrt{10} \] 
	\[ |\ray{NM}| = \sqrt{0^{2} + 1^{2} + 3^{2}} = \sqrt{10} \] 
	\[ |\ray{KN}| = \sqrt{2^{2} + 5^{2} + 0^{2}} = \sqrt{29} \] 
	\[ |\ray{LM}| = \sqrt{2^{2} + 3^{2} + 0^{2}} = \sqrt{29} \] 
	c) 
...
\sol{
	...
	\[ \frac{5}{3} + y + 2z = 4 \Rightarrow \frac{7}{3}\]
	\[ y + 2z = \frac{7}{3}\]
