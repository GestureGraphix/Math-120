...
\sol{ \\
	...
	\[ t = 1 \quad \vec{r}(1) = \langle e^{2}, e^{-2}, 2 \sqrt{2} \rangle \]  
	\begin{enumerate}[label=(\alph*)]
		\item \textbf{Projection in the $xy$-plane:}
		...
		\begin{tikzpicture}[scale=1.5]
			...
			\fill[red] (1.6487,0.6065) circle (2pt) node[below right] {$\vec{r}\left(\frac{1}{2}\right)$};
			\fill[red] (2.7183,0.1353) circle (2pt) node[below right] {$\vec{r}(1)$};
			
			% Projection curve (approximate, adjust as needed)
			\draw[thick,blue,domain=0:1.2,samples=100] 
				plot ({exp(\x)},{exp(-\x)});
		\end{tikzpicture}
		
		\item \textbf{Projection in the $zx$-plane:}
		
		\begin{tikzpicture}[scale=1.5]
			% Axes
			\draw[thick,->] (-0.5,0) -- (5,0) node[right] {$z$};
			\draw[thick,->] (0,-0.5) -- (0,4.5) node[above] {$x$};
			
			% Plot points
			\fill[red] (0,1) circle (2pt) node[below left] {$\vec{r}(0)$};
			\fill[red] (0.707,1.6487) circle (2pt) node[below left] {$\vec{r}\left(\frac{1}{2}\right)$};
			\fill[red] (1.414,2.7183) circle (2pt) node[below left] {$\vec{r}(1)$};
		...
		\item \textbf{Projection in the $yz$-plane:}
		
		\begin{tikzpicture}[scale=1.5]
			% Axes
			\draw[thick,->] (-0.5,0) -- (4.5,0) node[right] {$z$};
			\draw[thick,->] (0,-0.5) -- (0,4.5) node[above] {$y$};
			
			% Plot points
			\fill[red] (0,1) circle (2pt) node[below left] {$\vec{r}(0)$};
			\fill[red] (0.707,0.6065) circle (2pt) node[below left] {$\vec{r}\left(\frac{1}{2}\right)$};
			\fill[red] (1.414,0.1353) circle (2pt) node[below left] {$\vec{r}(1)$};
