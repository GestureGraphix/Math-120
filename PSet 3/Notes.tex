...
\sol{
	...
	\[ x(t) = e^{2t} \quad z(t) = \sqrt{8t} \]
	b)
	\[ L = \int_{t_{1}}^{t_{2}} ||\vec{r}(t)|| dt \]
	\[ \vec{r}(t) = \langle e^{2t}, e^{-2t}, \sqrt{8t} \rangle \]
	\[ \vec{r}'(t) = \left\langle \frac{d}{dt} \left(e^{2t} \right), \frac{d}{dt} \left(e^{-2t} \right) \frac{d}{dt} \left( \sqrt{8t} \right) \right\rangle \]   
	\[ \vec{r}'(t) = \left\langle 2e^{2t} , -2e^{-2t} \frac{4}{\sqrt{8t}} \right\rangle \]   
	\[ ||\vec{r}'(t)|| = \sqrt{\left(2e^{2t}\right)^{2} + \left(-2e^{2t}\right)^{2} + \left(\frac{4}{\sqrt{8t}}\right)^{2}}\] 
